                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <div className="flex items-center border border-zinc-200 rounded-lg gap-4 px-2 py-1">
                                                        <button onClick={() => updateQuantity(item.id, item.variation.id, -1)} className="text-zinc-500 hover:text-primary transition-colors"><Minus className="w-4 h-4" /></button>
                                                        <span className="font-bold min-w-[20px] text-center">{item.quantity}</span>
                                                        <button onClick={() => updateQuantity(item.id, item.variation.id, 1)} className="text-zinc-500 hover:text-primary transition-colors"><Plus className="w-4 h-4" /></button>
                                                    </div>
