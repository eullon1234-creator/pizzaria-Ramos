...
-- Permitir que CLIENTES criem depoimentos (sempre inativos)
CREATE POLICY "Permitir criação pública de depoimentos"
ON testimonials FOR INSERT
WITH CHECK (is_active = false);

-- Permitir que ADMIN faça tudo (ativar, editar, deletar)
...
-- ==========================================
-- ✅ PRONTO! Após executar, você terá:
-- - Tabela testimonials criada
-- - 6 depoimentos de exemplo (ativos)
-- - Clientes podem enviar depoimentos (inativos)
-- - Admin pode ativar/editar/deletar pelo painel
-- ==========================================
